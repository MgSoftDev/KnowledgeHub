...
![status](https://img.shields.io/badge/estado-v0.7.1--preview.1-blue)
...
Tests/KnowledgeHub.ParityHarness/  Arnés de paridad (99 checks) sobre 4 modos de store
```
...
**v0.7.1-preview.1**. Las 10 librerías + 3 demos compilan sin warnings; el arnés de paridad pasa
99/99 en los 4 modos de store; los demos están verificados end-to-end.
