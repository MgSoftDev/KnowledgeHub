...
![status](https://img.shields.io/badge/estado-v0.16.0--preview.1-blue)
...
Tests/KnowledgeHub.ParityHarness/  Arnés de paridad (169 checks) sobre 4 modos de store
```
...
**v0.16.0-preview.1**. Las 11 librerías + 3 demos compilan sin warnings; el arnés de paridad pasa
169/169 en los 4 modos de store; los demos están verificados end-to-end.
