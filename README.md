...
![status](https://img.shields.io/badge/estado-v0.9.1--preview.1-blue)
...
**v0.9.1-preview.1**. Las 10 librerías + 3 demos compilan sin warnings; el arnés de paridad pasa
